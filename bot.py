    ...
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Channel", url="https://t.me/maxgiveawayss"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/maxgiveaway")
                    ],[
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/AutoAcceptUserRoBot?startgroup")
                    ]
                ]
            ...
            await cb.message.edit("**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @Privates_RoBot__**".format(cb.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard, disable_web_page_preview=True)
